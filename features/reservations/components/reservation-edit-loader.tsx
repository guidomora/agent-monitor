export function ReservationEditLoader() {
  return (
    <svg
      aria-label="Guardando cambios en la reserva"
      role="img"
      height="56"
      width="56"
      viewBox="0 0 56 56"
    ...
    >
      <clipPath id="reservation-loader-sand-mound-top">
        <path
          ...
          className="reservation-loader__sand-mound-top"
        />
      </clipPath>
      <clipPath id="reservation-loader-sand-mound-bottom">
        <path
          ...
          className="reservation-loader__sand-mound-bottom"
        />
      </clipPath>
      <g transform="translate(2,2)">
        ...
        >
          <circle
            ...
            cx="26"
            strokeWidth="2.5"
            className="reservation-loader__motion-thick"
          />
          <circle
            transform="rotate(90,26,26)"
            r="24.5"
            ...
            cx="26"
            strokeWidth="1.75"
            className="reservation-loader__motion-medium"
          />
          <circle
            ...
            cx="26"
            strokeWidth="1"
            className="reservation-loader__motion-thin"
          />
        </g>
        <g transform="translate(13.75,9.25)" className="reservation-loader__model">
          <path
            ...
            fill="hsl(var(--reservation-loader-hue),90%,85%)"
          />
          ...
          <g strokeLinecap="round" stroke="hsl(35,90%,90%)">
            <line
              ...
              strokeWidth="1"
              className="reservation-loader__sand-grain-left"
            />
            <line
              y2="21.75"
              x2="12.5"
              ...
              strokeDasharray="0.25 33.75"
              strokeWidth="1"
              className="reservation-loader__sand-grain-right"
            />
            <line
              y2="31.5"
              x2="12.25"
              ...
              strokeWidth="1"
              className="reservation-loader__sand-drop"
            />
            <line
              y2="31.5"
              x2="12.25"
              ...
              strokeWidth="1.5"
              className="reservation-loader__sand-fill"
            />
            <line
              y2="31.5"
              x2="12"
              ...
              strokeWidth="1"
              stroke="hsl(35,90%,83%)"
              className="reservation-loader__sand-line-left"
            />
            <line
              y2="31.5"
              x2="12.5"
              ...
              strokeWidth="1"
              stroke="hsl(35,90%,83%)"
              className="reservation-loader__sand-line-right"
            />
          ...
          <g strokeWidth="2" strokeLinecap="round" opacity="0.7" fill="none">
            <path
              ...
              stroke="hsl(0,0%,100%)"
              className="reservation-loader__glare-top"
            />
            <path
              transform="rotate(180,12.25,16.75)"
              d="M 19.437 3.421 C 19.437 3.421 19.671 6.454 17.914 8.846 C 16.157 11.238 14.5 11.5 14.5 11.5"
              stroke="hsla(0,0%,100%,0)"
              className="reservation-loader__glare-bottom"
            />
          </g>
          ...
          <rect
            height="2"
            width="24.5"
            fill="hsl(var(--reservation-loader-hue),90%,50%)"
          />
          <rect
            height="1"
            width="19.5"
            ...
            ry="0.5"
            rx="0.5"
            fill="hsl(var(--reservation-loader-hue),90%,57.5%)"
          />
          <rect
            height="2"
            width="24.5"
